...
export type GetAllDoctorsQuery = { __typename?: 'Query', getDoctors: Array<{ __typename?: 'Doctor', id: string, calLink: string, calUserId: number, user: { __typename?: 'PulseUser', id: string, fullName: string, email: string, address: string, createdAt: any, phoneNumber: string, updatedAt: any, uniqueName: string }, specializations?: Array<{ __typename?: 'Specialization', name: string, id: string, description: string }> | null }> };
